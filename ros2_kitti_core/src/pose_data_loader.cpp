...
bool PoseDataLoader::prepare_data_internal([[maybe_unused]] std::size_t idx) { return true; }

PoseDataLoader::OptionalReturnType PoseDataLoader::get_data_internal(std::size_t idx)
{
